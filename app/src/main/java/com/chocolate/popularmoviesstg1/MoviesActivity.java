package com.chocolate.popularmoviesstg1;
...
public class MoviesActivity extends AppCompatActivity {
    ...
    String LOG_TAG = "MoviesActivity";

    //Add your api key here
    String api_key = "52074ce487a9b92174de8a2f1c182fd7";
    ...
    public class FetchMovies extends AsyncTask<String, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            imageAdapter = new ImageAdapter(MoviesActivity.this, posters);
